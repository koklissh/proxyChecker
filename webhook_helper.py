...
def send_webhook(added_count, removed_count, working_proxies):
    print(f"Webhook debug - URL: {config.DISCORD_WEBHOOK_URL[:50]}...")
    ...
    try:
        ...
        for i in range(0, min(len(working_proxies), 75), proxies_per_embed):
        ...
        print(f"Webhook sent successfully! Total: {total} proxies")
